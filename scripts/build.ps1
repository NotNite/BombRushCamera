...
$rootDir = "."
$project = "$rootDir/BombRushCamera/BombRushCamera.csproj"
$thunderstoreDir = "$rootDir/thunderstore"

$buildDir = "$rootDir/BombRushCamera/bin/Release/net462"
$outDir = "$rootDir/out"
$thunderstorePluginDir = "$thunderstoreDir/BepInEx/plugins/BombRushCamera"
...
# GitHub release
$version = (Get-Item "$buildDir/BombRushCamera.dll").VersionInfo.ProductVersion
